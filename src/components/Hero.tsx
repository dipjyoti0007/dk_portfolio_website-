          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            <div className="fade-in-up">
              ...
              <div className="bg-gradient-to-r from-primary/5 to-accent/5 p-6 rounded-lg mb-8">
                <p className="text-lg text-muted-foreground leading-relaxed">Hi, I'm Dipjyoti Kodali, a final-year student and tech innovator passionate about Embedded Systems, IoT, and Data Analytics.</p>
              </div>
